...
void calculate_gross_profit_loss() {
    ...
    printf("Gross profit/loss in total: %.2f\n", gross_profit_loss_total);
...
void calculate_operating_profit() {
    ...
    double operating_profit = total_revenue - (total_gross_profit + total_expenses);
    double profit_percentage = (operating_profit / total_revenue) * 100;

    printf("Operating profit: %.2f\n", operating_profit);
...
void gross_profit_margin_analysis() {
    ...
    for (int i = 0; i < num_prices; i++) {
        ...
        double profit_percentage = (profit / selling_price) * 100;
